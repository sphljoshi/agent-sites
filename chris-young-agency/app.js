...
function brandMarkup() {
  ...
  // "Chris Young" bold + "Agency" light  (Policygenius-style)
  return `<span class="brand-bold">Chris Young</span><span class="brand-light">Agency</span>`;
}
...
/* =============================================================
   ...
   ============================================================= */
const PAGE_TITLES = {
  index: `${AGENT.name} | Life & Commercial Insurance in ${AGENT.location}`,
  about: `About ${AGENT.name} | Life & Commercial Insurance in ${AGENT.location}`,
...
function buildFooter() {
  ...
  footer.innerHTML = `
    ...
    <div class="wrap footer__bottom">
      <span>© ${year} Chris Young Agency. All rights reserved.</span>
    </div>`;
}
...
function initHome() {
  ...
  if (ht)
    ht.innerHTML = `Insurance built around you.`;
      ...
      return `<section class="service-block">
        ...
        <div class="service-block__body">
          <div class="service-block__media">
            <img src="${img}" alt="${s.label} — Doran Lee Grohs">
