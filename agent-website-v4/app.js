    ...
    <div class="wrap">
      <div class="newsletter">
        <div class="newsletter__text">
          <h2 class="newsletter__title">Get Your Free Quote</h2>
          <p class="newsletter__sub">Compare personal, commercial and life coverage across 90+ trusted carriers with ${AGENT.firstName}.</p>
...
function initHome() {
  ...
  if (media) {
    ...
    const slides = serviceKeys().map((k) => ({
